...
import { SafeCast } from @openzeppelincontractsutilsmathSafeCast.sol;

import { Ownable } from @openzeppelincontractsaccessOwnable.sol;

import { IStargate, StargateType } from ..interfacesIStargate.sol;
import { IStargateFeeLib, FeeParams } from ..interfacesIStargateFeeLib.sol;
...
struct FeeConfig {
    ...
    uint24 zone1FeeMillionth;  in millionth (11_000_000)
